...
# Definindo a função da questão 7
def funcao7(x1, x2):
...
f_best = funcao7(x_best[0], x_best[1])
...
# Executando o GRS para a função da questão 7
resultado = []
for i in range(100):
    resultado.append(grs(x_best, f_best, max_iteracoes, min_max, funcao7))
