...
# Definindo a função da questão 6
def funcao6(x1, x2):
...
f_best = funcao6(x_best[0], x_best[1])
...
# Executando o GRS para a função da questão 6
resultado = []
for i in range(100):
    resultado.append(grs(x_best, f_best, max_iteracoes, min_max, funcao6))
